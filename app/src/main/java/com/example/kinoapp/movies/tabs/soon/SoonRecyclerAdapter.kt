...
class SoonRecyclerAdapter(
    private val item: List<Soon>,
    private val onItemClickListener: (Soon) -> Unit,
) : RecyclerView.Adapter<SoonRecyclerAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater
            .from(parent.context)
            .inflate(R.layout.item_soon, parent, false)
    ...
    inner class ViewHolder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun bind(item: Soon){
            ...
            itemViewGroup = itemView.findViewById(R.id.itemSoonViewGroup)
